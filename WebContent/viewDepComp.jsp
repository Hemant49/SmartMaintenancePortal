                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    <li class="menu active">
                        <a href="#dashboard" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
                                <span>Home</span>
                            </div>
                            <div>
                        ...
                        <ul class="collapse submenu recent-submenu mini-recent-submenu list-unstyled show" id="dashboard" data-parent="#accordionExample">
                            <li class="active">
                                <a href="user_profile.html"> Admin Profile </a>
                            </li>
                            <li>
                                <a href="pages_contact_us.html"> Admin Contact </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="menu active">
                        <a href="#forms" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle">
                            <div class="">
                                ...
                                <span>Department Complaint</span>
                            </div>
                          </a>  
                        ...
                        <ul class="collapse submenu list-unstyled show" id="forms" data-parent="#accordionExample">
                            ...
                            <li class="active">
                                <a href="viewDepComp.jsp"> View Complaints </a>
                            </li>
                            <li class="active">
                                <a href="viewPendingcomp.jsp"> View pending Complaints </a>
                            </li>
                           <li class="active">
                                <a href="viewCompletecomp.jsp"> View pending Complaints </a>
                            </li>
                        </ul>
                    </li>
                    <li class="menu">
                        <a href="viewRoad.jsp" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-layout"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="3" y1="9" x2="21" y2="9"></line><line x1="9" y1="21" x2="9" y2="9"></line></svg>
                                <span>View Road Maintenance</span>
                            </div>
                        </a>
                    </li>
...
<%
                ...
                try{
                PreparedStatement ps = con.prepareStatement("select * from complaint where department=?");
               	ps.setString(1,GetSet.getDname());
                                    ...
                                    <div class="note-item all-notes note-personal">
                                        <div class="note-inner-content">
                                            <div class="note-content">
                                                <p class="note-title" data-noteTitle="Meeting with Kelly"><%=rs.getString("title")%></p>
                                                <p class="meta-time"><%=rs.getString("department")%></p><br>
                                                <p class="meta-time"><%=rs.getString("date")%></p>
                                                <div class="note-description-content">
                                                    <p class="note-description" data-noteDescription="Curabitur facilisis vel elit sed dapibus sodales purus rhoncus."><%=rs.getString("description")%>.</p>
                                                </div><br>
                                                <div class="note-description-content">
                                                    <p class="note-title" data-noteDescription="Curabitur facilisis vel elit sed dapibus sodales purus rhoncus.">
                                                     Comment : 
                                                    <%=rs.getString("comment")%>.</p>
                                                </div>
                                            </div>

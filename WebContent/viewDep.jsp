    ...
    <div class="main-container sidebar-closed sbar-open" id="container">
     ...
     <div id="content" class="main-content">
            <div class="layout-px-spacing">
                ...
                try{
                PreparedStatement ps = con.prepareStatement("select * from department_details");
         ...
         %>
                                <tbody>
                                    <tr>
					                    ...
					                    <td><button class="btn btn-outline-info mb-2"><%=rs.getString("depname")%></button></td>

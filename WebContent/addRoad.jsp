    ...
    <div class="main-container sidebar-closed sbar-open" id="container">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
					...
					<li class="menu active">
                        ...
                        <ul class="collapse submenu list-unstyled show" id="forms" data-parent="#accordionExample">
                            ...
                            <li class="active">
                                <a href="addDep.html"> Add Department </a>
                            </li>
                            <li class="active">
                                <a href="viewDep.jsp"> View/Delete Department </a>
                            </li>
                    ...
                    <li class="menu">
                        <a href="addRoad.jsp" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-move"><polyline points="5 9 2 12 5 15"></polyline><polyline points="9 5 12 2 15 5"></polyline><polyline points="15 19 12 22 9 19"></polyline><polyline points="19 9 22 12 19 15"></polyline><line x1="2" y1="12" x2="22" y2="12"></line><line x1="12" y1="2" x2="12" y2="22"></line></svg>
                                <span>Add Road Maintenance</span>
                            </div>
                        </a>
                    </li>
                    <li class="menu">
                        <a href="ViewAllcomp.jsp" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-move"><polyline points="5 9 2 12 5 15"></polyline><polyline points="9 5 12 2 15 5"></polyline><polyline points="15 19 12 22 9 19"></polyline><polyline points="19 9 22 12 19 15"></polyline><line x1="2" y1="12" x2="22" y2="12"></line><line x1="12" y1="2" x2="12" y2="22"></line></svg>
                      ...
                      <li class="menu active">
                        <a href="addHelpline.html" aria-expanded="true" class="dropdown-toggle">
                            <div class="">
        ...
        <div id="content" class="main-content">
            <div class="container">
                                ...
                                <div class="widget-header">
                                    <div class="row">
                                        <div class="col-xl-12 col-md-12 col-sm-12 col-12"><br>
                                            <h4>Add Road Maintenance</h4>
                                        </div>                                                                        
                                    </div>
                                </div>
                                
                                <div class="widget-content widget-content-area">
                                    <form action="insertRoad.jsp">
                                        <div class="form-row mb-4">

                                            <div class="form-group col-md-6"><br>
                                            <label for="inputEmail4">Road name</label>
                               
                                            
                                                
                                                <input name="roadname" type="text" class="form-control" id="inputEmail4" placeholder="Road name" value=>
                                            </div>
                ...
                PreparedStatement ps1 = obj.prepareStatement("select depname from department_details");
         ...
         %>
                                                    ...
                                                    <option><%=rs.getString("depname")%></option>
            ...
            <%
                ...
                catch(Exception e)
                {
                  ...
                  %>
                                        ...
                                        <div class="form-row mb-4">
                                            <div class="form-group col-md-6">
                                                <label for="inputCity">Deadline Date</label>

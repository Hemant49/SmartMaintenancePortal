                        ...
                        <div id="flFormsGrid" class="col-lg-12 layout-spacing">
                            <div class="statbox widget box box-shadow">
                                ...
                                <div class="widget-content widget-content-area">
                                    <form action="insertComplaint.jsp">
                                        <div class="form-row mb-4">
                                            ...
                                            <label for="inputEmail4">Title</label>
                                                ...
                                                <input name="title" type="text" class="form-control" id="inputEmail4" placeholder="Title" value=>
                                            </div>
                  ...
                  %>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="inputEmail4">Description</label>
                                                ...
                                                <input name="description" type="text" class="form-control" id="inputEmail4" placeholder="Description" value=>
                                            </div>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="inputEmail4">Comment</label>
                                                ...
                                                <input name="comment" type="text" class="form-control" id="inputEmail4" placeholder="Add Comment" value=>
                                            </div>
                                      ...
                                      <button id="block-page" class="mr-2 btn btn-primary">Add</button>

...
<body class="alt-menu sidebar-noneoverflow">
    ...
    <div class="main-container sidebar-closed sbar-open" id="container">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu active">
                        ...
                        <ul class="collapse submenu list-unstyled show" id="forms" data-parent="#accordionExample">
                            ...
                            <li class="active">
                                <a href="viewCompletecomp.jsp"> View Completed Complaints </a>
                            </li>
       ...
       <%
                ...
                try{
                PreparedStatement ps = con.prepareStatement("select * from complaint where status=? and department=?");
               	ps.setString(1,"pending");
               	ps.setString(2,GetSet.getDname());
...
%>                      
                                            ...
                                            <td><button class="btn btn-outline-info mb-2"><%=rs.getString("department")%></button></td>
                                            <td><%=rs.getString("date")%></td>
                                            
                                            
                                            <td class="text-center"><a href="complete.jsp?id=<%=rs.getString("id")%>">Pending</a></td>
                                        </tr>
                                              <%
                }
                }

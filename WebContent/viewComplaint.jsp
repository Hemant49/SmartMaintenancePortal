...
<body class="alt-menu sidebar-noneoverflow">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu active">
                        ...
                        <ul class="collapse submenu list-unstyled show" id="forms" data-parent="#accordionExample">
                            ...
                            <li class="active">
                                <a href="viewComplaint.jsp"> View Complaint </a>
                            </li>
                                ...
                                <div class="tab-title">
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-12 text-center">
                                            <a id="btn-add-notes" class="btn btn-primary" href="javascript:void(0);">View User Complaint</a>
                                        </div>
  ...
  <%
                ...
                try{
                PreparedStatement ps = con.prepareStatement("select * from complaint where email=? and password=?");
                ps.setString(1, GetSet.getEmail() );
                ps.setString(2, GetSet.getPassword());
